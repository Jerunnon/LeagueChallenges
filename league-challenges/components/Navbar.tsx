...
export const Navbar = () => {
    return (
        <nav className="bg-space border-b border-gray-700 top-0 px-2 sm:px-4 py-2.5 w-full">
            <div className="container flex flex-wrap items-center justify-end ml-auto gap-4">
               <div id="iconGroup" className="flex items-center justify-center" style={{'gap': '.75rem'}}>
